...
public partial class PersonaDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) => optionsBuilder.UseSqlServer("name=ConnectionStrings:ContextConnection");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Estudio>(entity =>
        {
            entity.HasKey(e => new { e.IdProf, e.CcPer }).HasName("PK__estudios__FB3F71A608D33D64");
        ...
        {
            entity.HasKey(e => e.Cc).HasName("PK__persona__3213666D2CA9984C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__profesio__3213E83F6BC75777");
        ...
        {
            entity.HasKey(e => e.Num).HasName("PK__telefono__DF908D65184C542E");
